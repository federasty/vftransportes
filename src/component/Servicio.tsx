      ...
      <div className={`relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="text-center mb-20 sm:mb-24">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-black mb-8 leading-tight">
            <span className="bg-gradient-to-r from-white via-green-100 to-white bg-clip-text text-transparent drop-shadow-[0_0_80px_rgba(16,185,129,0.5)]">
          ...
          <p className="text-gray-300 text-lg sm:text-xl lg:text-2xl max-w-4xl mx-auto leading-relaxed font-light">
            Soluciones integrales de transporte de materiales con <span className="text-green-400 font-extrabold">tecnología Mercedes-Benz</span>, 
            <span className="text-emerald-400 font-extrabold"> seguridad certificada ISO 9001</span> y <span className="text-teal-400 font-extrabold">compromiso inquebrantable</span> con la excelencia
          </p>
        </div>
